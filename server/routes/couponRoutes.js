...
import { applyCoupon, createCoupon, deleteCoupon, getAllCouponsByAdmin, getValidCouponViaUser, toggleCouponStatus, updateCoupon } from '../controllers/couponController.js';

const couponRoute = express.Router();

couponRoute.get("/all", isAuth, getValidCouponViaUser);
couponRoute.post("/apply" , isAuth, applyCoupon);
//web 
